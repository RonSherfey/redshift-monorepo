...
function setupTestSuite(
  refundPublicKey: string = refunder.publicKey,
...
describe('UTXO BIP68 HTLC - No Admin Refund - PubKey Refund - Bitcoin Network', () => {
  before(async () => {
  ...
  describe('Refund', () => {
    ...
    describe('P2WPKH Address Refund Success Case', async () => {
      setupTestSuite(refunder.publicKey, RELATIVE_TIMELOCK);
    ...
    describe('P2WPKH Address Refund Failure Case', async () => {
      setupTestSuite(refunder.publicKey);
