...
export enum SimnetOnChainTicker {
  SBTC = 'SBTC', // Testnet Bitcoin
  SETH = 'SETH', // Kovan Testnet Ether
  SLTC = 'SLTC', // Testnet Litecoin
  SDAI = 'SDAI', // Kovan Testnet DAI
  SXLM = 'SXLM', // Testnet Stellar Lumens
  SDCR = 'SDCR', // Testnet Decred
}
